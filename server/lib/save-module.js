...
function saveModule (module_id, user_id, name, medals, trophies, callback) {
    // var moduleQuery = 'INSERT INTO modules (module_id, user_id, name) VALUES ( $1, $2, $3); INSERT INTO medals (module_id, medal_name, condition) VALUES ($1, $4, $5), ($1, $6, $7), ($1, $8, $9); INSERT INTO trophies (module_id, trophy_name, condition) VALUES ($1, $10, $11), ($1, $12, $13), ($1, $14, $15), ($1, $16, $17);';
    // var moduleArray = [module_id, user_id, name, medals.medal_name[0], medals.condition[0], medals.medal_name[1], medals.condition[1], medals.medal_name[2], medals.condition[2], trophies.trophy_name[0], trophies.condition[0], trophies.trophy_name[1], trophies.condition[1], trophies.trophy_name[2], trophies.condition[2], trophies.trophy_name[3], trophies.condition[3]];
