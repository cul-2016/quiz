...
function saveClient (client, payload, callback) {
    ...
    var queryText = 'INSERT INTO account_management (name, email, institution, department, account_type, paid, user_limit, group_code) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) ON CONFLICT (email) DO UPDATE SET name = EXCLUDED.name, institution = EXCLUDED.institution, department = EXCLUDED.department, account_type = EXCLUDED.account_type, paid = EXCLUDED.paid, code = EXCLUDED.code;';
