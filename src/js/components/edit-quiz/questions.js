    ...
    let mappedQuestions = questions.map((question, i) => {
        return (
            <div key={ i } className="column is-6 is-offset-3 question box">
                ...
                <span><input className="radio column is-1 radio-button" type="radio" checked={ question.correct_answer === 'a' } name={ i } value="a" onClick={ (e) => handleInputChange('correct_answer', e.target.value, i) } onChange={ (e) => handleInputChange('correct_answer', e.target.value, i) } /></span>
                ...
                <span><input className="radio column is-1 radio-button" type="radio" checked={ question.correct_answer === 'b' } name={ i } value="b" onClick={ (e) => handleInputChange('correct_answer', e.target.value, i) } onChange={ (e) => handleInputChange('correct_answer', e.target.value, i) } /></span>
                ...
                <span><input className="radio column is-1 radio-button" type="radio" checked={ question.correct_answer === 'c' } name={ i } value="c" onClick={ (e) => handleInputChange('correct_answer', e.target.value, i) } onChange={ (e) => handleInputChange('correct_answer', e.target.value, i) } /></span>
                ...
                <span><input className="radio column is-1 radio-button" type="radio" checked={ question.correct_answer === 'd' } name={ i } value="d" onClick={ (e) => handleInputChange('correct_answer', e.target.value, i) }
                onChange={ (e) => handleInputChange('correct_answer', e.target.value, i) } /></span>
